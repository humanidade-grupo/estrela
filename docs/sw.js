/* Estrela Urbanidade — Painel Comercial
   ...
   Atualizado em: 24/08/2026 — o botão Atualizar passa a sincronizar de
   verdade na metade do Parque (rota ?app=sync&fn=rodar do Cofre).
   Estratégia: rede primeiro (pega versão nova quando online), cache como
   reserva offline. A cada deploy, bumpar a versão em CACHE. */
const CACHE = 'estrela-painel-260824-1';
